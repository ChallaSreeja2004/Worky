...
> **Purpose:** A complete, self-contained guide to implementing a Worky connector from scratch — independently, without needing to understand any other connector's implementation.
...
2. [Connector Lifecycle](#2-connector-lifecycle)
3. [Folder Structure](#3-folder-structure)
4. [File Responsibilities](#4-file-responsibilities)
5. [Step 1 — Settings](#5-step-1--settings)
6. [Step 2 — API Client](#6-step-2--api-client)
7. [Step 3 — Fetchers](#7-step-3--fetchers)
8. [Step 4 — Models](#8-step-4--models)
9. [Step 5 — Normalizer](#9-step-5--normalizer)
10. [Step 6 — Connector](#10-step-6--connector)
11. [Step 7 — Router (Optional)](#11-step-7--router-optional)
12. [ConnectorResult Reference](#12-connectorresult-reference)
13. [Authentication Pattern](#13-authentication-pattern)
