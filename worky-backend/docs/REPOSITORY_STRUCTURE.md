...
| File | Audience |
|---|---|
| `README.md` | All — project entry point |
| `ARCHITECTURE.md` | All engineers — layered architecture, module responsibilities, data flow |
| `CONNECTOR_GUIDE.md` | Connector developers — step-by-step implementation guide |
| `CONTRIBUTING.md` | All contributors — standards, conventions, PR process |
| `ROADMAP.md` | Team and stakeholders — implementation phases and status |
| `DECISIONS.md` | Engineers, architects, judges — rationale for every major decision |
| `REPOSITORY_STRUCTURE.md` | New team members — this file |
| `GIT_WORKFLOW.md` | All contributors — branch strategy, commits, releases |
| `TEAM_WORKFLOW.md` | All contributors — parallel development, integration points |
